...
model_cela_BR3 <- lm(presence_94_2024_celastrina_BR3_df$occupancy ~ year, data = presence_94_2024_celastrina_BR3_df)
summary(model_cela_BR3)
#guardamos el valor de r2 para incorporarlo al grafico
r2value_cela_BR3 <- summary(model_cela_BR3)$r.squared
r_2_cela_text_BR3 <- paste0("R² = ", round(r2value_cela_BR3, 2))
##
gg_occupancy_cela_BR3 <-
  ...
  annotate("text",
           x = max(presence_94_2024_celastrina_BR3_df$year), # Puedes ajustar esto al inicio de tu eje X o un valor específico
           y = max(presence_94_2024_celastrina_BR3_df$occupancy), # Puedes ajustar esto al final de tu eje Y o un valor específico
           label = r_2_cela_text_BR3,
...
##Calculem regresio lineal simple
model_cyani_BR3 <- lm(presence_94_2024_cyaniris_BR3_df$occupancy ~ year, data = presence_94_2024_cyaniris_BR3_df)
summary(model_cyani_BR3)
#guardamos el valor de r2 para incorporarlo al grafico
r2value_cyani_BR3 <- summary(model_cyani_BR3)$r.squared
r_2_cyani_text_BR3 <- paste0("R² = ", round(r2value_cyani_BR3, 2))
##
...
##Calculem regresio lineal simple
model_lycaena_BR3 <- lm(presence_94_2024_lycaena_BR3_df$occupancy ~ year, data = presence_94_2024_lycaena_BR3_df)
summary(model_lycaena_BR3)
#guardamos el valor de r2 para incorporarlo al grafico
r2value_lycaena_BR3 <- summary(model_lycaena_BR3)$r.squared
r_2_lycaena_text_BR3 <- paste0("R² = ", round(r2value_lycaena_BR3, 2))
##
...
gg_occupancy_plebe_BR3 <-
  ...
  geom_point(size = 0.8) +
  geom_smooth(method = "lm", se = TRUE , color = "steelblue4", fill = "steelblue4") + # Línea de tendencia lineal sin error estándar
  labs(title = "Plebejus argus", x = NULL, y = NULL) +
  scale_x_continuous(breaks = my_custom_breaks) +
  theme_minimal() + theme(plot.title = element_text(face = "italic", hjust = 0.5, size = 10),
                          )+
  annotate("text",
           x = max(presence_94_2024_plebejus_BR3_df$year)+0.05, # Puedes ajustar esto al inicio de tu eje X o un valor específico
           y = max(presence_94_2024_plebejus_BR3_df$occupancy), # Puedes ajustar esto al final de tu eje Y o un valor específico
...
##Calculem regresio lineal simple
model_vane_BR3 <- lm(presence_94_2024_vanessa_BR3_df$occupancy ~ year, data = presence_94_2024_vanessa_BR3_df)
summary(model_vane_BR3)
#guardamos el valor de r2 para incorporarlo al grafico
r2value_vane_BR3 <- summary(model_vane_BR3)$r.squared
r_2_vane_text_BR3 <- paste0("R² = ", round(r2value_vane_BR3, 2))
##
gg_occupancy_vane_BR3 <-
  ...
  theme_minimal() + theme(plot.title = element_text(face = "italic", hjust = 0.5, size = 10),
                          ...
                          axis.title.y = element_blank())+
  annotate("text",
           x = max(presence_94_2024_vanessa_BR3_df$year), # Puedes ajustar esto al inicio de tu eje X o un valor específico
           y = min(presence_94_2024_vanessa_BR3_df$occupancy)+0.02, # Puedes ajustar esto al final de tu eje Y o un valor específico
           label = r_2_vane_text_BR3,
...
##Calculem regresio lineal simple
model_pseudophilotes_BR3 <- lm(presence_94_2024_pseudophilotes_BR3_df$occupancy ~ year, data = presence_94_2024_pseudophilotes_BR3_df)
summary(model_pseudophilotes_BR3)
#guardamos el valor de r2 para incorporarlo al grafico
r2value_pseudophilotes_BR3 <- summary(model_pseudophilotes_BR3)$r.squared
r_2_pseudophilotes_text_BR3 <- paste0("R² = ", round(r2value_pseudophilotes_BR3, 2))
##
gg_occupancy_pseudo_BR3 <-
  ...
  theme_minimal() + theme(plot.title = element_text(face = "italic", hjust = 0.5, size = 10),
                          ...
                          axis.title.y = element_blank())+
  annotate("text",
           x = max(presence_94_2024_pseudophilotes_BR3_df$year), # Puedes ajustar esto al inicio de tu eje X o un valor específico
           y = max(presence_94_2024_pseudophilotes_BR3_df$occupancy), # Puedes ajustar esto al final de tu eje Y o un valor específico
           label = r_2_pseudophilotes_text_BR3,
           hjust = 1, vjust = 1, # Ajusta justificación para que el texto empiece en (x,y)
           size = 2.5, fontface = "bold") # Puedes ajustar el tamaño y estilo de la fuente
##
...
gg_occupancy_aglais_BR3 <-
  ...
  labs(title = "Aglais io  ", x = NULL, y = NULL) +
  scale_x_continuous(breaks = my_custom_breaks) +
  theme_minimal() + theme(plot.title = element_text(face = "italic", hjust = 0.5, size = 10),
                          )+
  annotate("text",
           x = max(presence_94_2024_aglais_BR3_df$year), # Puedes ajustar esto al inicio de tu eje X o un valor específico
           y = max(presence_94_2024_aglais_BR3_df$occupancy), # Puedes ajustar esto al final de tu eje Y o un valor específico
...
##Calculem regresio lineal simple
model_melanargia_BR3 <- lm(presence_94_2024_melanargia_BR3_df$occupancy ~ year, data = presence_94_2024_melanargia_BR3_df)
summary(model_melanargia_BR3)
#guardamos el valor de r2 para incorporarlo al grafico
r2value_melanargia_BR3 <- summary(model_melanargia_BR3)$r.squared
r_2_melanargia_text_BR3 <- paste0("R² = ", round(r2value_melanargia_BR3, 2))
##
gg_occupancy_mela_BR3 <- 
  ...
  theme_minimal() + theme(plot.title = element_text(face = "italic", hjust = 0.5, size = 10),
                          ...
                          axis.title.y = element_blank())+
  annotate("text",
           x = max(presence_94_2024_melanargia_BR3_df$year), # Puedes ajustar esto al inicio de tu eje X o un valor específico
           y = max(presence_94_2024_melanargia_BR3_df$occupancy), # Puedes ajustar esto al final de tu eje Y o un valor específico
           label = r_2_melanargia_text_BR3,
           hjust = 1, vjust = 1, # Ajusta justificación para que el texto empiece en (x,y)
           size = 2.5, fontface = "bold") # Puedes ajustar el tamaño y estilo de la fuente
##
...
##Calculem regresio lineal simple
model_pararge_BR3 <- lm(presence_94_2024_pararge_BR3_df$occupancy ~ year, data = presence_94_2024_pararge_BR3_df)
summary(model_pararge_BR3)
#guardamos el valor de r2 para incorporarlo al grafico
r2value_pararge_BR3 <- summary(model_pararge_BR3)$r.squared
r_2_pararge_text_BR3 <- paste0("R² = ", round(r2value_pararge_BR3, 2))
##
##
gg_occupancy_pararge_BR3 <-
  ...
  theme_minimal() + theme(plot.title = element_text(face = "italic", hjust = 0.5, size = 10),
                          ...
                          axis.title.y = element_blank())+
  annotate("text",
           x = max(presence_94_2024_pararge_BR3_df$year), # Puedes ajustar esto al inicio de tu eje X o un valor específico
           y = max(presence_94_2024_pararge_BR3_df$occupancy), # Puedes ajustar esto al final de tu eje Y o un valor específico
           label = r_2_pararge_text_BR3,
           hjust = 1, vjust = 1, # Ajusta justificación para que el texto empiece en (x,y)
           size = 2.5, fontface = "bold") # Puedes ajustar el tamaño y estilo de la fuente
##
...
model_pyroceci_BR3 <- lm(presence_94_2024_pyroniaceci_BR3_df$occupancy ~ year, data = presence_94_2024_pyroniaceci_BR3_df)
summary(model_pyroceci_BR3)
#guardamos el valor de r2 para incorporarlo al grafico
r2value_pyroceci_BR3 <- summary(model_pyroceci_BR3)$r.squared
r_2_pyroceci_text_BR3 <- paste0("R² = ", round(r2value_pyroceci_BR3, 2))
##
gg_occupancy_pyroceci_BR3 <-
  ...
  theme_minimal() + theme(plot.title = element_text(face = "italic", hjust = 0.5, size = 10),
                          ...
                          axis.title.y = element_blank())+
  annotate("text",
           x = max(presence_94_2024_pyroniaceci_BR3_df$year), # Puedes ajustar esto al inicio de tu eje X o un valor específico
           y = max(presence_94_2024_pyroniaceci_BR3_df$occupancy), # Puedes ajustar esto al final de tu eje Y o un valor específico
           label = r_2_pyroceci_text_BR3,
           hjust = 1, vjust = 1, # Ajusta justificación para que el texto empiece en (x,y)
           size = 2.5, fontface = "bold") # Puedes ajustar el tamaño y estilo de la fuente
##
...
gg_occupancy_Pyrobath_BR3 <-
  ...
  labs(title = "Pyronia bathseba  ", x = NULL, y = NULL) +
  scale_x_continuous(breaks = my_custom_breaks) +
  theme_minimal() + theme(plot.title = element_text(face = "italic", hjust = 0.5, size = 10),
                          )+
  annotate("text",
           x = max(presence_94_2024_pyroniabath_BR3_df$year), # Puedes ajustar esto al inicio de tu eje X o un valor específico
           y = max(presence_94_2024_pyroniabath_BR3_df$occupancy), # Puedes ajustar esto al final de tu eje Y o un valor específico
...
###calculem regresio lineal simple
model_antho_BR3 <- lm(presence_94_2024_anthocharis_BR3_df$occupancy ~ year, data = presence_94_2024_anthocharis_BR3_df)
summary(model_antho_BR3)
#guardem el valor de r2 per afegirlo al grafic
r2value_antho_BR3 <- summary(model_antho_BR3)$r.squared
r_2_antho_text_BR3 <- paste0("R² = ", round(r2value_antho_BR3, 2))
##
gg_occupancy_Antho_BR3 <-
  ...
  theme(plot.title = element_text(face = "italic", hjust = 0.5, size = 10),
        ...
        axis.title.y = element_blank()) +
  annotate("text",
           x = max(presence_94_2024_anthocharis_BR3_df$year), # Puedes ajustar esto al inicio de tu eje X o un valor específico
           y = max(presence_94_2024_anthocharis_BR3_df$occupancy), # Puedes ajustar esto al final de tu eje Y o un valor específico
           label = r_2_antho_text_BR3,
           hjust = 1, vjust = 1, # Ajusta justificación para que el texto empiece en (x,y)
           size = 2.5, fontface = "bold") # Puedes ajustar el tamaño y estilo de la fuente
...
gg_occupancies_BR3
ggsave("ocupancies_BR3.png", plot = gg_occupancies_BR3, path = "/home/dalonso/PROJECT_JOANA_TFG/GRAFICS/", width = 15, height = 10, units = "in", dpi = 500)

########################

gg_occupancies_BR3_significatives <- (gg_occupancy_plebe_BR3+gg_occupancy_aglais_BR3+gg_occupancy_Pyrobath_BR3)+
plot_layout(
  ncol = 1, 
  axes = 'collect',       
  axis_titles = 'collect' 
...
ggsave("ocupancies_BR3_significatives.png", plot = gg_occupancies_BR3_significatives, path = "/home/dalonso/PROJECT_JOANA_TFG/GRAFICS/", width = 15, height = 10, units = "in", dpi = 500)
