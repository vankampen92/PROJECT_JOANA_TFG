...
NLL2 <- vector()
NNL2 <- (colext_Results_df_BR1_ordenado$NLL + colext_Results_df_BR2_ordenado$NLL + colext_Results_df_BR3_ordenado$NLL)
AIC2 <- vector()
AIC2 <- 12 + 2*(NNL2)
...
colext_Results_df_ordenado$Dif <- (colext_Results_df_ordenado$AIC2 - colext_Results_df_ordenado$AIC)
...
# Horizontal bar plot
gg_deltaAIC <-
  ggplot(colext_Results_df_ordenado, aes(y = species, x = Dif ,fill = species )) +
